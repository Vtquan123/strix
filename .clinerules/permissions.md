...
Explicit allow/deny for the Execution Runtime. Derived from the
...
| Action | Reason |
|--------|--------|
| Write `knowledge/**` | Knowledge is Claude-only, read-only for Cline |
| Write `knowledge/decisions/**` (ADRs) | Decisions belong to Claude |
