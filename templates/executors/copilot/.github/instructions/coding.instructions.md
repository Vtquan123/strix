...
applyTo: "**"
---
# Strix coding rules (executor)

Apply these whenever you edit a source file in this repository as the Strix
executor.

<!-- strix:gen start id=shared.coding -->
The executor writes code that matches the project. The authoritative style source
...
- The executor **reads** conventions; it never edits them. A needed change is
...
<!-- strix:gen end id=shared.coding -->
